...
const FitnessProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success("Your goal and intake details have been updated.");
    } catch (err) {
  ...
  if (authLoading || (userRole === "client" && loading)) {
    return (
  ...
  return (
    <div className="container max-w-2xl mx-auto px-4 py-10 flex-1 w-full">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-foreground">Your Goal</h1>
          <p className="text-muted-foreground mt-2">
            View and update your details so your coach can tailor your nutrition and training.
          </p>
        </div>
